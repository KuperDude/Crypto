...
class DetailViewModel: ObservableObject {
    ...
    private func createOverviewArray(coinModel: CoinModel) -> [StatisticModel] {
        let price = coinModel.currentPrice?.asCurrencyWith6Decimals() ?? "$0.00"
        ...
        let marketCapStat = StatisticModel(title: "Market Capitalization", value: marketCap, persentageChange: marketCapPercentChange)
